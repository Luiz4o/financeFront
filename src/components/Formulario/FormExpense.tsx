...
function FormularioExpense(Form:IFormulario) {
    ...
    const handleCreate = async() => {
        ...
        const res = await axiosInstance.post('/createExpense',{
          cost: parseCost,
          description,
          userId
        })
        ...
        setError("Erro ao cadastrar nova despesa. Por favor, tente novamente mais tarde.");
      }
    };
...
export default FormularioExpense